...
<ul class="pagination">
  	<li data-page=1>
		<c:if test="${pageObject.page > 1 }">
			<!-- 맨 첫페이지로 이동 -->
	  		<a href="${listURI }?page=1&perPageNum=${pageObject.perPageNum}&area=${pageObject.area}&theme=${pageObject.theme}&word=${pageObject.word}${query}"
	...
	<li data-page=${pageObject.startPage -1 }>
		<c:if test="${pageObject.startPage > 1 }">
	  		<a href="${listURI }?page=${pageObject.startPage - 1 }&perPageNum=${pageObject.perPageNum}&area=${pageObject.area}&theme=${pageObject.theme}&word=${pageObject.word}${query}"
	...
	<c:forEach begin="${pageObject.startPage }" end="${pageObject.endPage }" var="cnt">
  	<li ${(pageObject.page == cnt)?"class=\"active\"":"" } 
  	 data-page=${cnt }>
  	 	...
  	 	<c:if test="${pageObject.page != cnt }">
  			<a href="${listURI }?page=${cnt }&perPageNum=${pageObject.perPageNum}&area=${pageObject.area}&theme=${pageObject.theme}&word=${pageObject.word}${query}"
	...
	<c:if test="${pageObject.endPage < pageObject.totalPage }">
	  	<li data-page=${pageObject.endPage + 1 }>
	  		<a href="${listURI }?page=${pageObject.endPage + 1 }&perPageNum=${pageObject.perPageNum}&area=${pageObject.area}&theme=${pageObject.theme}&word=${pageObject.word}${query}"
	...
	<c:if test="${pageObject.page < pageObject.totalPage }">
	  	<li data-page=${pageObject.totalPage }>
	  		<a href="${listURI }?page=${pageObject.totalPage }&perPageNum=${pageObject.perPageNum}&area=${pageObject.area}&theme=${pageObject.theme}&word=${pageObject.word}${query}"
