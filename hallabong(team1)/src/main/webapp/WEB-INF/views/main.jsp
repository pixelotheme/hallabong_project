        ...
        <div class="container pt-5 pb-3">
            ...
            <div class="row pb-3 bigdata">
             <c:forEach items="${bulist }" var="vo" varStatus="vs">
                <div class="col-lg-4 col-md-6 mb-4 pb-2" id="dataRow">
                        ...
                        <div class="bg-white p-4">
                            ...
                            <div class="h5 m-0 text-decoration-none" >${vo.content }</div>
                        </div>
                  </div>
                </c:forEach>
                </div>
            ...
            <div class="row rentdata">
             <c:forEach items="${rentlist }" var="vo" varStatus="vs">
                <div class="col-lg-4 col-md-6 mb-4 ">
                    <div class="package-item bg-white mb-2 " id="cardata">
                        <img class="img-fluid" src="${vo.fileName }" alt="">
                        <div class="p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fas fa-car text-primary mr-2"></i>${vo.carName }</small>
                                <small class="m-0"><i class="fas fa-car-battery text-primary mr-2"></i>${vo.companyName}</small>
                            </div>
