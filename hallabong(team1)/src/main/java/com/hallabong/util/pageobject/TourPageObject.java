package com.hallabong.util.pageobject;

import javax.servlet.http.HttpServletRequest;

public class TourPageObject {
	...
	public TourPageObject(long page, long perPageNum) {
		this.page = page;
	...
	public static TourPageObject getInstance(HttpServletRequest request) throws Exception {
		request.setCharacterEncoding("UTF-8");
		// 페이지 처리를 위한 프로그램
		// 페이지 처리를 위한 객체 사용
		TourPageObject pageObject = new TourPageObject();
		// 페이지에 대한 정보를 받는다.
	...
	public static TourPageObject getInstance(HttpServletRequest request, String pageName, String perPageNumName) throws Exception {
	...
	public String toString() {
		return "PageObject [page=" + page + ", perPageNum=" + perPageNum + ", startRow=" + startRow + ", endRow="
				...
				+ ", totalPage=" + totalPage + ", totalRow=" + totalRow + ", word=" + word + ", theme="
				+ theme + ", area=" + area + ", period=" + period + ", accepter=" + accepter + ", acceptMode="
				+ acceptMode + "]";
	}
