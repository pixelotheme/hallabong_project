package com.hallabong.util.businesspageobject;
...
public class BusinessPageObject {
	...
	public BusinessPageObject(long page, long perPageNum) {
		this.page = page;
	...
	public static BusinessPageObject getInstance(HttpServletRequest request) throws Exception {
		request.setCharacterEncoding("UTF-8");
		// 페이지 처리를 위한 프로그램
		// 페이지 처리를 위한 객체 사용
		BusinessPageObject pageObject = new BusinessPageObject();
		// 페이지에 대한 정보를 받는다.
	...
	public static BusinessPageObject getInstance(HttpServletRequest request, String pageName, String perPageNumName) throws Exception {
	...
	public String toString() {
		return "PageObject [page=" + page + ", perPageNum=" + perPageNum + ", startRow=" + startRow + ", endRow="
				...
				+ ", totalPage=" + totalPage + ", totalRow=" + totalRow + ", word=" + word + ", area="
				+ area + ", period=" + period + ", accepter=" + accepter + ", acceptMode="
				+ acceptMode + "]";
	}
